...
const Product = () => {
    return (
        ...
        <Row><p className="h2 text-center">Anatolia Cards</p>
        </Row>
  ...
  {cards.map((card)=>{
    return(
      <ListGroupItem key={card} className="py-1 card-properies-list">
  ...
  <Card.Text> {description} </Card.Text>
    <Card.Link href="#" className="product-details">Detail</Card.Link>
  </Card.Body>
</Card>
</Col>
          )
